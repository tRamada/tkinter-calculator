...
# Based on: https://www.studytonight.com/tkinter/calculator-application-using-tkinter

# IMPORTANT-> CODE JUST WORK IF THE INPUT NUMBER HAS BEEN INSERTED BY BUTTONS INSIDE THE PROGRAM.
...
#########################################################
# Function to center window in the middle of the screen
#########################################################
...
window = Tk()  # This is to create a basic window
center_window(312, 324) # this is for the size of the window
window.resizable(0, 0)  # this is to prevent from resizing the window
...
input_field = Entry(input_frame, font=('arial', 18, 'bold'),
                    textvariable=input_text, width=50, bg="#eee", bd=0, justify=CENTER)
